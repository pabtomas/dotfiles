...
DOCKER_COMPONENT_IMG="${OWNER_ID}/${DOCKER_COMPONENT_ID}:${DOCKER_COMPONENT_TAG}"
GIT_COMPONENT_IMG="${OWNER_ID}/${GIT_COMPONENT_ID}:${GIT_COMPONENT_TAG}"
LINGUIST_COMPONENT_IMG="${OWNER_ID}/${LINGUIST_COMPONENT_ID}:${LINGUIST_COMPONENT_TAG}"
MAN_COMPONENT_IMG="${OWNER_ID}/${MAN_COMPONENT_ID}:${MAN_COMPONENT_TAG}"
PASS_COMPONENT_IMG="${OWNER_ID}/${PASS_COMPONENT_ID}:${PASS_COMPONENT_TAG}"
...
VIM_COMPONENT_IMG="${OWNER_ID}/${VIM_COMPONENT_ID}:${VIM_COMPONENT_TAG}"
WORKSPACES_COMPONENT_IMG="${OWNER_ID}/${WORKSPACES_COMPONENT_ID}:${WORKSPACES_COMPONENT_TAG}"
